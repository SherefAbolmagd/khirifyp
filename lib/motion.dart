...
class MotionPage extends StatefulWidget {
  MotionPage({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _MotionPage createState() => _MotionPage();
}

class _MotionPage extends State<MotionPage> {
  double _value = 50.0;
  bool motion = false;
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                    ...
                    onPressed: () async {
                      try {
                        var url = "http://192.168.1.1/motion";
                ...
                Slider(
                  ...
                  onChanged: (value) async {
                    try {
                      var url = "http://192.168.1.1/motionlight?light=" +
